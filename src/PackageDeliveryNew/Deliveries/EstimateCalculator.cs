...
namespace PackageDeliveryNew.Deliveries
{
    public class EstimateCalculator
    {
            ...
            int? productId4, int amount4)
        {
            ...
            //double? distance = _addressResolver.GetDistance(delivery.Destination);
            //if (distance == null)
